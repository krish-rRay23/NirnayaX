...
- 🔄 **Jira Sync & Approval Gate**: Integrates Jira issues via an MCP-compatible adapter. Enforces explicit human approval for `CRITICAL/HIGH` risk actions or `SEV1/P1` incidents. **Critical incidents are never auto-closed**.
